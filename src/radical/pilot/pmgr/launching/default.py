...
class Default(PMGRLaunchingComponent):
    ...
    def initialize(self):
        ...
        self._sbox_cache    = dict()      # cache of resource sandbox URLs
    ...
    def _start_pilot_bulk(self, resource, schema, pilots):
        ...
        for pilot in pilots:
            pid      = pilot['uid']
            info_b   = self._prepare_bridge(resource, rcfg, pilot, expand)
            info_a   = self._prepare_pilot(resource, rcfg, pilot, expand)
            ft_list += info_b['ft']
            ft_list += info_a['ft']
